...
import EditDokumen from './pages/vendor/EditDokumen';

// Protected Route Component
const ProtectedRoute = ({ children, requiredRole }) => {
  const { isAuthenticated, userRole, hasRole, loading } = useAuth();
  ...
  return (
    <Routes>
      ...
      >
        ...
        <Route path="edit-dokumen/:type/:id" element={<EditDokumen />} />
